    ...
    <section id="primary" class="content-area">
        <main id="main" class="site-main pl-search-page">
                ...
                <div class="container">
                    ...
                    <div class="pt-20 md:pt-32 pb-32 md:max-w-[72rem] mx-auto text-center relative z-10">
                        ...
                        <div class="text-sm uppercase tracking-widest font-normal">
                            <strong class="font-normal"><?php _e('Showing Results', 'pl') ?></strong>
            ...
            <article class="container pt-12 md:pt-24">
                ...
                <?php
                endwhile;
                echo '<nav class="pl-pagination py-16 lg:py-20">';
