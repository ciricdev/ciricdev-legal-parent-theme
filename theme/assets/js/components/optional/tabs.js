...
class Tabs {
    constructor($root) {
        this.$root = $root;
        this.activeTabTarget = this.getTabTarget(this.$root.find('.pl-tabs__tab.active'));
    }

    get $controls() {
        return this.$root.find('.pl-tabs__tab');
    }

    get $wrapper() {
        return this.$root.find('.pl-tabs__contents-wrapper');
    }

    get $contents() {
        return this.$root.find('.pl-tabs__body');
    }
    ...
    getContentsForTabTarget(target) {
        return this.$root.find(`.pl-tabs__body#${target}`);
    }
