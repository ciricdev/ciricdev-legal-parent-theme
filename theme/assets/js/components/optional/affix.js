...
<div class="md:w-1/2 border-r-2 border-green max-md:order-2">
    <div class="mx-auto relative h-full pl-affix-container px-4 lg:px-0" data-affix-max-width="768">
        <div class="md:h-[400pxs]">
            <p class="text-2xl font-serif font-normal leading-relaxed text-green-black pt-4 md:pt-32 lg:pt-48 pl-affix" data-affix-position="top" data-affix-buffer="20"><?php the_field('left_text') ?></p>
        </div>

        <div class="text-center pt-8 md:pt-96">
            <div class="pl-affix pl-block-progression-list__button" data-affix-position="bottom" data-affix-buffer="200">
